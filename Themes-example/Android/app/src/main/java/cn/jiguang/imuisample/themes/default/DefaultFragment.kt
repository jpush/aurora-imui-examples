...
import cn.jiguang.imuisample.databinding.FragmentDefaultBinding
...
class DefaultFragment: Fragment(), View.OnTouchListener {
    ...
    var binding: FragmentDefaultBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        if (binding == null) {
            binding = FragmentDefaultBinding.bind(root!!)
        }
        mViewModel = DefaultActivity.obtainViewModel(activity)
        setup()
