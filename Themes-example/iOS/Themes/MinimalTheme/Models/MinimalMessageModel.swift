...
class MinimalMessageModel: IMUIMessageModel {
  ...
  override var resizableBubbleImage: UIImage {
    ...
    if isOutGoing {
      bubbleImg = UIImage(named: "outgoing_minimal_bubble")
      bubbleImg = bubbleImg?.resizableImage(withCapInsets: UIEdgeInsetsMake(24, 14, 14, 14), resizingMode: .tile)
    } else {
      bubbleImg = UIImage(named: "incoming_minimal_bubble")
      bubbleImg = bubbleImg?.resizableImage(withCapInsets: UIEdgeInsetsMake(24, 14, 14, 14), resizingMode: .tile)
    }
  ...
  convenience init(text: String, isOutGoing: Bool) {
    ...
    let myLayout = MinimalMessageCellLayout(isOutGoingMessage: isOutGoing,
...
class MinimalMessageCellLayout: IMUIMessageCellLayout {
  ...
  override public var bubbleContentView: IMUIMessageContentViewProtocol {
    ...
    if type == "voice" {
      return VoiceMinimalContentView()
    }
...
class MinimalContentView: UIView, IMUIMessageContentViewProtocol{
